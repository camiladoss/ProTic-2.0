                            ...
                            <div>
                                <div className="flex -mx-3">
                                    ...
                                    <div className="w-full px-3 mb-12">
                                        <label htmlFor="user-password" className="text-xs font-semibold px-1">Password</label>
                                        <div className="flex">
                                            <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-lock-outline text-gray-400 text-lg"></i></div>
                                            <input className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="************"
                                            id="user-password"
                                            name="password"
                                            type="password"
                                            {...register("password",{
                                                ...
                                                pattern: {
                                                    value: /^[a-zA-Z0-9_-]{6,16}$/i ,
                                                    massage: "El valor no es correcto",
                                                }
                                            })}
                                            />
                                            {errors.password?.type === 'required' && <span className="text-red-600">"El password es requerido!"</span>}
                                            {errors.password?.type === 'pattern' && <span className="text-red-600">"El password no cumple!"</span>}
                                        </div>
                                    </div>
                                </div>
                                <div className="flex -mx-3">
                                    <div className="w-full px-3 mb-5">
                                        <button className="block w-full max-w-xs mx-auto bg-indigoDye hover:bg-carolinaBlue focus:bg-carolinaBlue text-white rounded-lg px-3 py-3 font-semibold"
                                        type="submit">
                                            INGRESAR
                                        </button>
                                    </div>
                                ...
                                <div className="flex -mx-3">
                                    <div className="w-full px-3 mb-5">
                                        <button className="block w-full max-w-xs mx-auto bg-maximunBlue hover:bg-powderBlue focus:bg-carolinaBlue text-white rounded-lg px-3 py-3 font-semibold"
                                        type="button"
                                        onClick={()=>{changePage();}}
                                        >
                                            REGISTRARSE
                                ...
                                <div className="text-center mb-10">
                                    <div className="w-full px-3 mb-5">
                                        <Link to="/auth/passwordReset">
                                            <i className="text-indigoDye hover:text-carolinaBlue">Olvide la contraseña</i>
                                        </Link>
                                    </div>
                                </div>
                            </div>
