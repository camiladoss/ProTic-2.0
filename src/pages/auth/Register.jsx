                            ...
                            <div>
                                <div className="flex -mx-3">
                                    <div className="w-1/2 px-3 mb-5">
                                        <label htmlFor="user-name" className="text-xs font-semibold px-1">Nombre</label>
                                        <div className="flex">
                                    ...
                                    <div className="w-1/2 px-3 mb-5">
                                        <label htmlFor="user-lastname" className="text-xs font-semibold px-1">Apellido</label>
                                        <div className="flex">
                                ...
                                <div className="flex -mx-3">
                                    <div className="w-full px-3 mb-5">
                                        <label htmlFor="usuario-id" className="text-xs font-semibold px-1">Identificación</label>
                                        <div className="flex">
                                            <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                                                <i className="mdi mdi-email-outline text-gray-400 text-lg"></i>
                                            </div>
                                            <input className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
                                            placeholder="121354968"
                                            id="usuario-id"
                                            name="identificacion"
                                            type="text"
                                ...
                                <div className="flex -mx-3">
                                    <div className="w-full px-3 mb-5">
                                        <label htmlFor="user-rol" className="text-xs font-semibold px-1">Rol de Usuario</label>
                                        <div className="flex">
                                            <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-email-outline text-gray-400 text-lg"></i></div>
