...
import { GET_FILTRARINSCRIPCION } from 'graphql/inscripcion/queries'
import { toast } from 'react-toastify';
// import useFormData from 'hooks/useFormData';
import { EDITAR_INSCRIPCION } from 'graphql/inscripcion/mutations';
...
const CrearInscripcion = () => {
  ...
  const navigate = useNavigate ();
    ...
    const {data:queryData,error:queryError,loading:queryLoading} = useQuery(GET_FILTRARINSCRIPCION,{
        variables:{_id}
    });
    const [editarInscripcion, {error: mutationError}] = useMutation(EDITAR_INSCRIPCION);
    ...
    useEffect(() => {
        ...
        if(mutationError){
            toast.error('Error modificado el inscripciones')
        }
        ...
        <div className="grid grid-cols-1 gap-y-5 gap-x-10 mx-3 mb-6 md:grid-cols-2 items-center">
          <div className="w-full md:mb-0 flex flex-col ">
            ...
            <input
              ...
              id="grid-first-name"
              type="text"
              defaultValue={queryData.filtrarInscripcion.nombre}
            ...
            />
            {errors.nombreProyecto?.type === 'required' && <span className="text-red-600">"El nombre es requerido!"</span>}
            {errors.nombreProyecto?.type === 'pattern' && <span className="text-red-600">"El nombre solo puede llevar letras!"</span>}
          </div>
          <div className="w-full md:mb-0 flex flex-col">
            <label className="text-gray-700 text-md font-bold" htmlFor="grid-objG">
              ID del proyecto:
            </label>
            <input
              ...
              defaultValue={queryData.filtrarInscripcion.proyecto._id}
              disabled
              name="idProyecto"
              {...register("idProyecto",{
                required: {
          ...
          <div className="w-full md:mb-0 flex flex-col">
            ...
            <input
              ...
              defaultValue={queryData.filtrarInscripcion.estudiante._id}
              name="idEstudiante"
              disabled
          ...
          <div className="w-full md:mb-0 flex flex-col">
            ...
            <input
              ...
              defaultValue={queryData.filtrarInscripcion._id}
              name="idInscripcion"
              disabled
              {...register("idInscripcion",{
                required: {
                    value:true,
                    massage: "El campo es requerido"
                },
          ...
          <div className="w-full md:mb-0 flex flex-col">
            ...
            <input 
              ...
              defaultValue={queryData.filtrarInscripcion.fechaIngreso}
              name="fechaIngreso"
              {...register("fechaIngreso",{
                ...
                pattern: {
                    value: /([0-2][0-9]|3[0-1])(\/|-)(0[1-9]|1[0-2])\2(\d{4})$/i, 
                    massage: "El valor no es correcto",
                }
            })}
            />
            {errors.fechaIngreso?.type === 'required' && <span className="text-red-600">"La fecha es requerida!"</span>}
            {errors.fechaIngreso?.type === 'pattern' && <span className="text-red-600">"La fecha solo puede llevar dd/mm/yyyy!"</span>}
          </div>
          ...
          <div className="w-full md:mb-0 flex flex-col">
            ...
            <input 
              ...
              defaultValue={queryData.filtrarInscripcion.fechaEgreso}
              name="fechaEgreso"
            ...
            />
            {errors.fechaEgreso?.type === 'required' && <span className="text-red-600">"La fecha es requerida!"</span>}
            {errors.fechaEgreso?.type === 'pattern' && <span className="text-red-600">"La fecha solo puede llevar dd/mm/yyyy!"</span>}
          </div>

          <div className="w-full  mb-6 md:mb-0">
            <label className="text-gray-700 text-md font-bold" htmlFor="grid-state">
              Estado:
            </label>
            <div className="relative">
              <select
                ...
                id="grid-state"
                defaultValue={queryData.filtrarInscripcion.estado}
                name="estado"
                {...register("estado",{
                    required: {
                        value:true,
